...
│ - Анализ темы, аудитории, конкурентов │
│ - Сбор ключевых фактов и статистики │
└─────────────────┬───────────────────────────┘
│ research_material
▼
┌──────────────────────────────────────────────────────────────────────┐
│ STRATEGIST (Стратег) │
│ - Разрабатывает Core Message │
│ - Создает структуру контента │
│ - Определяет Tone of Voice │
│ - Формирует план продвижения │
└─────────────────────────────────┬────────────────────────────────────┘
│ strategy
▼
┌──────────────────────────────────────────────────────────────────────┐
│ COPYWRITER (Копирайтер) │
│ - Создает черновик контента │
│ - Учитывает фидбек редактора (при RETRY) │
└─────────────────────────────────┬────────────────────────────────────┘
│ draft
▼
┌──────────────────────────────────────────────────────────────────────┐
│ EDITOR (Редактор) │
│ 1. Редактирует текст (стиль, грамматика, логика) │
│ 2. Оценивает качество по 5 критериям │
│ 3. Принимает решение: APPROVE или RETRY │
└─────────────────────────────────┬────────────────────────────────────┘
│ quality_decision
│
┌─────────────┴─────────────┐
